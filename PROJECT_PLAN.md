...
### Visão Geral (Lambda Architecture: Batch + Streaming)

O projeto implementa uma **Lambda Architecture** híbrida, combinando processamento em batch (análises históricas) com streaming em tempo real (detecção de fraudes instantânea).
...
│  │   │                        Metabase                             │   │   │
│  │   │                                                             │   │   │
│  │   │  Dashboard de BI para análise de fraudes                   │   │   │
│  │   │                                                             │   │   │
│  │   │  • KPIs de fraude (Recall, Precision, F1)                 │   │   │
│  │   │  • Gráficos por categoria/estado/horário                   │   │   │
│  │   │  • Alertas por nível de risco                              │   │   │
│  │   │  • Métricas financeiras (R$ protegido/perdido)            │   │   │
│  │   │                                                             │   │   │
│  │   └─────────────────────────────────────────────────────────────┘   │   │
│  │                                                                      │   │
│  └──────────┬───────────────────────────────────────────────────────────┘   │
...
│  │   │              │                                                  │   │
│  │   │  Rotas:      │                                                  │   │
│  │   │  • metabase.abnerfonseca.com.br → Metabase ✅                  │   │
│  │   │  • spark.abnerfonseca.com.br → Spark UI ✅                     │   │
│  │   │  • minio.abnerfonseca.com.br → MinIO Console ✅                │   │
│  │   └──────────────┘                                                  │   │
│  │                                                                      │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
...
├── 📂 spark/
│   └── 📂 jobs/
│       ├── 📂 production/          # Jobs batch (Bronze/Silver/Gold)
│       │   ├── 📄 medallion_bronze.py
│       │   ├── 📄 medallion_silver.py
│       │   └── 📄 medallion_gold.py
│       └── 📂 streaming/           # Jobs streaming (Kafka → MinIO)
│           ├── 📄 streaming_bronze.py
│           ├── 📄 streaming_silver.py
│           └── 📄 streaming_gold.py
│
├── 📂 shadowtraffic/               # Gerador de dados streaming
│   ├── 📄 license.env              # Licença ShadowTraffic
│   └── 📄 transactions.json        # Config de geração
│
...
5. 🔄 Implementar **Streaming Real-time** com ShadowTraffic

##### Prioridade 2 (Próxima semana)
6. ⬜ Criar entidades **Cards** (para regra Account Takeover)
7. ⬜ Implementar **Chargebacks** pipeline
8. ⬜ Criar **Blocklist** e **Audit Log**
...
- [x] URLs públicas com SSL Let's Encrypt
...
| **Banco de Dados** | PostgreSQL | 16 | ✅ Funcionando |
| **BI** | Metabase | Latest | ✅ Funcionando |
| **Proxy** | Traefik | Latest | ✅ Funcionando |
| **Containers** | Docker / Docker Compose | Latest | ✅ Funcionando |
| **SO** | Ubuntu | 25.04 | ✅ Funcionando |
